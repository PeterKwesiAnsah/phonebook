...
export const DataTableContext = React.createContext<Omit<DataTableProviderProps, 'children'>>({
    columns: [],
    EmptyTableComponent: <></>,
...
export const DataTableProvider = ({ children, ...rest }: DataTableProviderProps) => {
    return (
